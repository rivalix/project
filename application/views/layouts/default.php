...
<html>
  <head lang="en">
    <meta charset="UTF-8">
    <title><?php echo $template['title']; ?></title><!--[if IE]>
    ...
    <?php echo link_tag('assets/css/theme-default.css'); ?>
    <!-- endbuild-->
              ...
              <ul class="auth__nav">
                <li class="dropdown auth__nav-item">
                  <div class="dropdown__menu auth__dropdown--restore">
                    <!-- BEGIN AUTH RESTORE-->
                    <h5 class="auth__title">Restablecer contraseña</h5>
                    <?php echo form_open('usuarios/restablecer-mi-credencial', array('class' => 'form form--flex form--auth form--restore js-restore-form js-parsley')) ?>
                      <div class="row">
                        <div class="form-group">
                          <label for="restore-email-dropdown" class="control-label">Ingrese su correo electrónico</label>
                          <input type="email" name="username" id="restore-email-dropdown" required data-parsley-required-message="Este campo es requerido" data-parsley-type-message="Digite un correo electrónico válido" class="form-control">
                        </div>
                      </div>
                      <div class="row">
                        <button type="submit" class="form__submit">Restablecer</button>
                      </div>
                      <div class="row">
                ...
                <li class="dropdown auth__nav-item">
                  ...
                  <div class="dropdown__menu auth__dropdown--login">
                    <!-- BEGIN AUTH LOGIN-->
                    <?php echo form_open('usuarios/iniciar-sesion', array('class' => 'form form--flex form--auth js-login-form js-parsley')) ?>
                      <h5 class="auth__title">Iniciar Sesión en su Cuenta</h5>
                        <div class="row">
                          <div class="form-group">
                            <label for="login-username-dropdown" class="control-label">Usuario</label>
                            <input type="email" name="username" id="login-username-dropdown" required data-parsley-required-message="El Usuario es requerido" data-parsley-type-message="El Usuario debe ser un correo electrónico válido" data-parsley-trigger="keyup" data-parsley-validation-threshold="5" class="form-control">
                          </div>
                          <div class="form-group">
                            <label for="login-password-dropdown" class="control-label">Contraseña</label>
                            <input type="password" name="password" id="login-password-dropdown" minlength="8" required data-parsley-required-message="La Contraseña es requerida" data-parsley-minlength-message="La Contraseña es demasiado corta. Debe tener 8 caracteres o más" data-parsley-trigger="keyup" data-parsley-validation-threshold="5" class="form-control">
                          </div>
                        </div>
                      <div class="row">
                      ...
                      <div class="row">
                        <div class="form__options">No es un usuario todavía?
                          <button type="button" class="js-user-register">Obtener una cuenta</button>
                        </div>
                      </div>
                    <?php echo form_close(); ?>
                    <!-- end of block .auth__form-->
                ...
                <li class="dropdown auth__nav-item">
                  ...
                  <div class="dropdown__menu auth__dropdown--register">
                    <!-- BEGIN AUTH REGISTER-->
                    <h5 class="auth__title">Registrar una cuenta nueva</h5>
                    <?php echo form_open('usuarios/registrar-una-cuenta-nueva', array('class' => 'form form--flex form--auth js-register-form js-parsley')); ?>
                      <div class="row">
                        <div class="form-group form-group--col-6">
                          <label for="register-name-dropdown" class="control-label">Nombres</label>
                          <input type="text" name="name" id="register-name-dropdown" required class="form-control">
                        </div>
                        <div class="form-group form-group--col-6">
                          <label for="register-lastname-dropdown" class="control-label">Apellidos</label>
                          <input type="text" name="lastname" id="register-lastname-dropdown" required class="form-control">
                        </div>
                      </div>
                      <div class="row">
                        <div class="form-group form-group--col-6">
                        ...
                        <div class="form-group form-group--col-6">
                          <label for="register-password-dropdown" class="control-label">Contraseña</label>
                  ...
                  <div role="menu" class="js-dropdown-menu navbar__dropdown navbar__dropdown--colls-1">
                    ...
                    <div class="navbar__submenu">
                      <ul class="navbar__subnav">
                        ...
                        <li class="navbar__subitem active"><a href="index_vmap_light.html" class="navbar__sublink js-navbar-sublink">Google Map & Light search</a></li>
